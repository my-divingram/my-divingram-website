...
export default function FishPageFooter() {
    return (
        <>
            ...
            <p className="pt-1 text-xs md:text-sm text-center text-gray-700 font-medium">写真提供のご依頼，誤同定のご指摘などは<Link href={"/#contact"} className="underline hover:opacity-50">こちら</Link>からお気軽にご連絡ください．</p>
        </>
    );
}