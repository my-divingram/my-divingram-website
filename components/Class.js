...
export function Family({family}) {
    return (
        <h3 className="pt-6 pb-2 text-lg md:text-xl text-center text-gray-700 font-medium border-b-4 border-dotted border-gray-500">{family}</h3>
    )
}
...
export function Genus({genus, data}) {
    return (
        <div>
            <h4 className="py-6 text-lg md:text-xl text-center text-gray-700 font-medium">{genus}</h4>
