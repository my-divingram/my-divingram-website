...
export default function Home({data_num, data_Parapriacanthus, data_Pempheris}) {
	...
	return (
		<Layout title="ハタンポの仲間 | 僕らむの魚図鑑" description="ハタンポの仲間の一覧です" url="https://my-divingram-website.vercel.app/fish/sweeper" imageUrl="https://my-divingram-website.vercel.app/img/class/sweeper.jpeg">
