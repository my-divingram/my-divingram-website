...
export default function Home({data_num, data_Sphyraena}) {
	...
	return (
		<Layout title="カマスの仲間 | 僕らむの魚図鑑" description="カマスの仲間の一覧です" url="https://my-divingram-website.vercel.app/fish/barracuda" imageUrl="https://my-divingram-website.vercel.app/img/class/barracuda.jpeg">
