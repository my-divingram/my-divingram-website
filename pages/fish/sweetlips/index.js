...
export default function Home({data_num, data_Parapristipoma, data_Plectorhinchus, data_Diagramma, data_Hapalogenys}) {
	...
	return (
		<Layout title="イサキの仲間 | 僕らむの魚図鑑" description="イサキの仲間の一覧です" url="https://www.my-divingram.com/fish/sweetlips" imageUrl="https://www.my-divingram.com/img/class/sweetlips.jpeg">
