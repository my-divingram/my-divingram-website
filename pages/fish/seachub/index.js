...
export default function Home({data_num, data_Kyphosus, data_Girella}) {
	...
	return (
		<Layout title="イスズミ・メジナの仲間 | 僕らむの魚図鑑" description="イスズミ・メジナの仲間の一覧です" url="https://www.my-divingram.com/fish/seachub" imageUrl="https://www.my-divingram.com/img/class/seachub.jpeg">
