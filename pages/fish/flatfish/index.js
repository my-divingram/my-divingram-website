...
export const getStaticProps = async() => {
	...
	const data_Cleisthenes = await client.get({ endpoint: "uwphoto", queries: { filters: `genus[equals]ソウハチ属` , limit: 100 }});
	...
	return {
    	props: {
    		...
    		data_Cleisthenes: data_Cleisthenes.contents.sort((a, b) => a.japaneseName.localeCompare(b.japaneseName), "ja"),
    	},
	};
};

export default function Home({data_num, data_Paralichthys, data_Asterorhombus, data_Bothus, data_Crossorhombus, data_Engyprosopon, data_Pleuronichthys, data_Aseraggodes, data_Brachirus, data_Pardachirus, data_Soleichthys, data_Cynoglossus, data_Pseudorhombus, data_Tarphops, data_Zebrias, data_Pseudopleuronectes, data_Limanda, data_Cleisthenes}) {
	...
	return (
		<Layout title="カレイの仲間 | 僕らむの魚図鑑" description="カレイの仲間の一覧です" url="https://www.my-divingram.com/fish/flatfish" imageUrl="https://www.my-divingram.com/img/class/flatfish.jpeg">
			<div className="px-5 md:px-20 bg-gradient-to-b from-white to-sky-100 font-sans">
				...
				<Genus genus="ソウハチ属 (Cleisthenes)" data={data_Cleisthenes}></Genus>
