...
export default function Home({data_num, data_Parapercis, data_Osopsaron}) {
	...
	return (
		<Layout title="トラギスの仲間 | 僕らむの魚図鑑" description="トラギスの仲間の一覧です" url="https://www.my-divingram.com/fish/sandperch" imageUrl="https://www.my-divingram.com/img/class/sandperch.jpeg">
