...
export default function Home({data_num, data_Pagrus, data_Acanthopagrus, data_Evynnis}) {
	...
	return (
		<Layout title="タイの仲間 | 僕らむの魚図鑑" description="タイの仲間の一覧です" url="https://my-divingram-website.vercel.app/fish/seabream" imageUrl="https://my-divingram-website.vercel.app/img/class/seabream.jpeg">
