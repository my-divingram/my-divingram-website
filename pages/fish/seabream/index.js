...
export default function Home({data_num, data_Pagrus, data_Acanthopagrus, data_Evynnis}) {
	...
	return (
		<Layout title="タイの仲間 | 僕らむの魚図鑑" description="タイの仲間の一覧です" url="https://www.my-divingram.com/fish/seabream" imageUrl="https://www.my-divingram.com/img/class/seabream.jpeg">
