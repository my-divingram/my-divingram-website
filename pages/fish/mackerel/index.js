...
export default function Home({data_num, data_Acanthocybium, data_Gymnosarda, data_Rastrelliger}) {
	...
	return (
		<Layout title="サバの仲間 | 僕らむの魚図鑑" description="サバの仲間の一覧です" url="https://my-divingram-website.vercel.app/fish/mackerel" imageUrl="https://my-divingram-website.vercel.app/img/class/mackerel.png">
