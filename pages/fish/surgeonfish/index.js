...
export default function Home({data_num, data_Zebrasoma, data_Acanthurus, data_Ctenochaetus, data_Naso, data_Paracanthurus, data_Prionurus}) {
	...
	return (
		<Layout title="ニザダイの仲間 | 僕らむの魚図鑑" description="ニザダイの仲間の一覧です" url="https://www.my-divingram.com/fish/surgeonfish" imageUrl="https://www.my-divingram.com/img/class/surgeonfish.png">
