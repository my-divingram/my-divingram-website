...
export default function Home({data_num, data_Lutjanus, data_Aphareus, data_Macolor, data_Paracaesio, data_Aprion, data_Symphorus}) {
	...
	return (
		<Layout title="フエダイの仲間 | 僕らむの魚図鑑" description="フエダイの仲間の一覧です" url="https://www.my-divingram.com/fish/snapper" imageUrl="https://www.my-divingram.com/img/class/snapper.jpeg">
