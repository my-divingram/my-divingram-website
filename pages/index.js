                ...
                <div className="max-w-2xl mx-auto px-5 md:px-0 flex flex-col">
                    <Link href="https://www.jstage.jst.go.jp/article/specdiv/31/1/31_SD25-07/_article" target="_blank" rel="noopener noreferrer" className="group flex items-start gap-3 py-1 border-b border-gray-100 last:border-none">
                        ...
                        <span className="text-sm md:text-base text-gray-700 group-hover:text-sky-700 transition-colors leading-relaxed">
                            <span className="italic">Hazeus atrispinalis</span>, a New Sand-dwelling Goby from the Western Pacific Ocean (Teleostei: Gobiidae)
                        </span>
                    </Link>
                    <Link href="https://www.jstage.jst.go.jp/article/bkpmnh/2026/55/2026_4/_article/-char/ja" target="_blank" rel="noopener noreferrer" className="group flex items-start gap-3 py-1 border-b border-gray-100 last:border-none">
                        ...
                        <span className="text-sm md:text-base text-gray-700 group-hover:text-sky-700 transition-colors leading-relaxed">
                            伊豆諸島御蔵島と伊豆大島から確認された日本初記録のアカマユトラギス（新称）<span className="italic">Parapercis rubromaculata</span>（ワニギス亜目トラギス科）
                        </span>
                    </Link>
