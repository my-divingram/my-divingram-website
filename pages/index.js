...
function Home({data_fish, data_blog}) {
    ...
    return (
        <Layout title="僕のだいびんぐらむ" description={description} url="https://my-divingram-website.vercel.app/" imageUrl="https://my-divingram-website.vercel.app/img/logo/ornate.png">
